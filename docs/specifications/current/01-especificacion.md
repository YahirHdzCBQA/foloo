...
| `REG-06` | Tocar un renglón abre el **detalle de la conexión**, en solo lectura: chips de tipo, interés y estado; foto de la tarjeta o el estado "Sin foto de la tarjeta"; contacto (correo, teléfono, puesto); nota de voz con reproductor y duración; nota escrita; y bloque de registro con folio, origen y quién capturó. | Debe | nuevo |
