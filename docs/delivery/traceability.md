...
| `PLT-*`, `SAL-*` | E-01/E-08 | ADR-006/007; D-09 y D-14–D-20 resueltas | FL-019: renderer/editor, Drift v8, Guardar → Revisar → confirmación explícita, follow-up e intent outbox, OAuth state+PKCE, Gmail/Graph provider boundary, KMS ciphertext, attachments D-19, opt-out y API/SQL 004+005. QA Google/Microsoft confirmó OAuth y entrega; corrección local interpreta Graph 202 vacío como aceptación y preserva asunto renderizado. Ajuste final mantiene CTA accesible con teclado y actualiza únicamente el asunto fallback de D-15, sin sobrescribir plantillas/snapshots. Pendiente redeploy/QA final; no cerrar; f2-04/05, f4-04/12 |
