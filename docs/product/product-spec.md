...
| `VOZ-04` | Audio y tarjeta se copian a storage privado local y sobreviven reinicio/logout. El borrador de voz previo a guardar también permanece en storage privado durante navegación temporal; solo guardar lo promueve al Lead y solo cancelar/descartar lo elimina. |
