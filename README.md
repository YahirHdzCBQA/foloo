...
under `app/`, and the AWS backend under `backend/`.
...
- `backend/`: Node.js/TypeScript API, PostgreSQL migrations and AWS CDK IaC for
  sync, private media/Content and Google/Microsoft follow-up.
